namespace MTDSpoofer_GUI
{
    partial class Spoofy
    {
        ...
        {
            // Carregar o GIF
            Image gifImage = Image.FromFile("settings.ico");

            // Definir o PictureBox
            PictureBox pictureBox = new PictureBox();
            pictureBox.Image = gifImage;

            // Definir o tamanho da imagem do ícone
            Size iconSize = new Size(SystemInformation.SmallIconSize.Width, SystemInformation.SmallIconSize.Height);
            pictureBox.Size = iconSize;

            // Converter a imagem do ícone para um ícone
            Icon icon = Icon.FromHandle(((Bitmap)gifImage).GetHicon());

            // Definir o ícone do aplicativo
            this.Icon = icon;

            // Limpar a memória do ícone
            icon.Dispose();*/
        ...
        private void InitializeComponent()
        {
            ...
            ///rgb = new MetroFramework.Controls.MetroCheckBox();
           ...
           /*sm.Animated = true;
            ...
            spoofall.Location = new Point(80, 120);
            spoofall.Name = "spoofall";
            spoofall.PressedDepth = 60;
            spoofall.Size = new Size(100, 32);
            spoofall.TabIndex = 17;
            spoofall.Text = "Spoofer";
            ...
            systemcleaner.Location = new Point(12, 180);
            ...
            logwind.Location = new Point(12, 204);
            ...
            // 
            //rgb.AutoSize = true;
            //rgb.Location = new Point(12, 385);
            //rgb.Name = "rgb";
            //rgb.Size = new Size(100, 15);
            //rgb.Style = MetroFramework.MetroColorStyle.Magenta;
            //rgb.TabIndex = 35;
            //rgb.Text = "rgb Mode";
            //rgb.TextAlign = ContentAlignment.TopLeft;
            //rgb.Theme = MetroFramework.MetroThemeStyle.Dark;
        ...
        private MetroFramework.Controls.MetroCheckBox rgb;
